...
#include <QMessageBox>
#include <iostream>
#include "../include/ssoni_gui/main_window.hpp"
...
void MainWindow::on_roi_send_button_clicked()
{
    saveROIValue(ui.roi_x_offset->text(), ui.roi_y_offset->text(), ui.roi_width->text(), ui.roi_height->text());

    qnode.roi_pub.publish(qnode.roi_msgs);
...
void MainWindow::saveROIValue(QString roi_x_offset, QString roi_y_offset, QString roi_width, QString roi_height)
{
    QString roi_x_offset_str;
    double  roi_x_offset_double = 0;

    QString roi_y_offset_str;
    double  roi_y_offset_double = 0;

    QString roi_width_str;
    double  roi_width_double = 0;

    QString roi_height_str;
    double  roi_height_double = 0;

    roi_x_offset_str = roi_x_offset;
    roi_x_offset_double = roi_x_offset_str.toDouble();

    roi_y_offset_str = roi_y_offset;
    roi_y_offset_double = roi_y_offset_str.toDouble();

    roi_width_str = roi_width;
    roi_width_double = roi_width_str.toDouble();

    roi_height_str = roi_height;
    roi_height_double = roi_height_str.toDouble();

    qnode.roi_msgs.x_offset = (unsigned int) roi_x_offset_double;
    qnode.roi_msgs.y_offset = (unsigned int) roi_y_offset_double;
    qnode.roi_msgs.width = (unsigned int) roi_width_double;
    qnode.roi_msgs.height = (unsigned int) roi_height_double;
